...
from todo.tasks_schemas import TaskQuerySchema, TaskSchema, SuccessMessageSchema
from todo import db
...
class Tasks(MethodView):
    ...
    def post(self, task_data):
        try:
            ...
            new_task = TaskModel(user_id=user_id, task_description=task_description, due_date=due_date, completed=completed)
